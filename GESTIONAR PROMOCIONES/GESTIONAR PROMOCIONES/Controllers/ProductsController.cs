...
namespace GESTIONAR_PROMOCIONES.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ProductsController(DB_ManagePromotionsContext context)
        {
            _context = context;
        }
        ...
        {
            var dB_ManagePromotionsContext = _context.Products.Include(p => p.Category);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Description,Price,Status,CategoryID")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
